...
dataarea_NEW$phase<-'2.NewStratMap'
dataarea_NEW
# area csv
...
dataarea_old$phase<-'1.OldStratMap'
...
AE_CI_plot
ggsave("my_AE_CI_plot_oldnew.jpeg",width = 14, height = 6, units = c("in"), dpi = 300)
dev.off()
graphics.off()
...
MOEplot
ggsave("my_MOE_oldnew.jpeg",width = 10, height = 6, units = c("in"), dpi = 300)
dev.off()
graphics.off()
