...
#COMMENTED OUT BECAUSE DOES NOT ACCOUNT FOR FINALLABELS DONE DURING REVIEW
...
FINALDATASET$CEOreadable_v8CORRECT_NEWstrata_perennialseparate_epoch1and23 <-  ifelse(FINALDATASET$FinalLabel %in% c("stable forest","stable nonforest"),FINALDATASET$FinalLabel,
...
table(FINALDATASET$CEOreadable_v8CORRECT_NEWstrata_perennialseparate_epoch1and23)


####### NEEDED RESULT
#final NEWSTRATA with epochs grouped
#final labels for NEW STRATA without testing details
FINALDATASET$CEOreadable_v8CORRECT_NEWstrata_perennialseparate_epochsgrouped <-  ifelse(FINALDATASET$FinalLabel %in% c("stable forest","stable nonforest"),FINALDATASET$FinalLabel,
                                                                                      ifelse(FINALDATASET$FinalLabel == "multiple events eco possible","multiple events",
                                                                                                                  ...
                                                                                                                  ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType1d == "Deforestation" & FINALDATASET$Change1yeard %in% c(2006:2018), 'Deforestation',
                                                                                                                         ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType2d == "Deforestation" & FINALDATASET$Change2yeard %in% c(2000:2005), 'Deforestation',
                                                                                                                                ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType2d == "Deforestation" & FINALDATASET$Change2yeard %in% c(2006:2018), 'Deforestation',
                                                                                                                                       ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType2d == "Deforestation" & FINALDATASET$Change2yeard %in% c(2000:2005), 'Deforestation',
                                                                                                                                              ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType2d == "Deforestation" & FINALDATASET$Change2yeard %in% c(2006:2018), 'Deforestation',
                                                                                                                                                     ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType1d != "Deforestation" & FINALDATASET$ChangeType3d == "Deforestation" & FINALDATASET$Change2yeard %in% c(2000:2005), 'Deforestation',
                                                                                                                                                            ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType1d != "Deforestation" & FINALDATASET$ChangeType3d == "Deforestation" & FINALDATASET$Change2yeard %in% c(2006:2018), 'Deforestation',
                                                                                                                                                                   ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType1d != "Deforestation" & FINALDATASET$ChangeType3d == "Deforestation" & FINALDATASET$Change2yeard %in% c(2000:2005), 'Deforestation',
                                                                                                                                                                          ifelse(FINALDATASET$FinalLabel == "Deforestation" & FINALDATASET$ChangeType1d != "Deforestation" & FINALDATASET$ChangeType3d == "Deforestation" & FINALDATASET$Change2yeard %in% c(2006:2018), 'Deforestation',   
                                                                                                                                                                                 ifelse(FINALDATASET$FinalLabel == "Deforestation", "NEEDS DEFORESTATION YEAR",
                                                                                                                                                                                        ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$ChangeType1d == "Deforestation" & FINALDATASET$ChangeType2d %!in% c("Degradation","Deforestation","Reforestation") & FINALDATASET$Change1yeard %in% c(2000:2005), 'Deforestation',
                                                                                                                                                                                               ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$ChangeType1d == "Deforestation" & FINALDATASET$ChangeType2d %!in% c("Degradation","Deforestation","Reforestation") & FINALDATASET$Change1yeard %in% c(2006:2018), 'Deforestation',
                                                                                                                                                                                                      ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$ChangeType1d == "Reforestation" & FINALDATASET$ChangeType2d %!in% c("Degradation","Deforestation","Reforestation") & FINALDATASET$Change1yeard %in% c(2000:2005), 'Reforestation',
                                                                                                                                                                                                             ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$ChangeType1d == "Reforestation" & FINALDATASET$ChangeType2d %!in% c("Degradation","Deforestation","Reforestation") & FINALDATASET$Change1yeard %in% c(2006:2018), 'Reforestation',       
                                                                                                                                                                                                                    ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$morethan3forestchangesd == "no", 'multiple events', #this is currently catching remaining Degradation labels and marking them as multiple events
                                                                                                                                                                                                                           ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible")& FINALDATASET$morethan3forestchangesd == "yes", 'multiple events',
                                                                                                                                                                                                                                  ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$ChangeType2d %in% c("Deforestation","Reforestation") & FINALDATASET$ThirdForestChangeEventd == "no", 'multiple events',
                                                                                                                                                                                                                                         ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$forestChangeEventd == "N/A non-forest entire time" & FINALDATASET$CropType2000d %!in% c("coconut / other palm","unsure","fruit trees (mango, cashew, avocado, rambutan durian)","banana"), "stable nonforest", #not labeled agro
                                                                                                                                                                                                                                                ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$forestChangeEventd == "N/A non-forest entire time" & FINALDATASET$CropType2000d %in% c("coconut / other palm","unsure","fruit trees (mango, cashew, avocado, rambutan durian)","banana"), "perennial crop",
                                                                                                                                                                                                                                                       ifelse(FINALDATASET$FinalLabel %!in% c("stable forest","stable nonforest","Deforestation","multiple events eco possible") & FINALDATASET$forestChangeEventd == "no", "stable forest",'NotReviewed')))))))))))))))))))))))))
table(FINALDATASET$CEOreadable_v8CORRECT_NEWstrata_perennialseparate_epochsgrouped)

#output all results of original data, everything cleaned up, before adding 79 new points
write.csv(FINALDATASET, file = 'Results\\COMPLETEDDATA_BEFOREADDING79NEWPOINTS.csv', row.names = F)
table(FINALDATASET$ReadableChangeStrata_Map_v4,FINALDATASET$CEOreadable_v8CORRECT_NEWstrata_perennialseparate_epochsgrouped)
crosstab_originaldata_allclean <- table(FINALDATASET$ReadableChangeStrata_Map_v4,FINALDATASET$CEOreadable_v8CORRECT_NEWstrata_perennialseparate_epochsgrouped)
write.csv(crosstab_originaldata_allclean, file = 'Results\\OriginalData_CleanCrossTab_FINAL.csv', row.names = T)
